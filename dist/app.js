...
/* harmony import */ var _save_warning__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./save-warning */ "./save-warning.js");

var commander = new _save_warning__WEBPACK_IMPORTED_MODULE_0__["Commander"]();
...
function showWarning() {
  ...
  if (warning) {
    ...
    document.body.insertAdjacentHTML('afterbegin', _save_warning__WEBPACK_IMPORTED_MODULE_0__["template"]);
...
function () {
  ...
  _createClass(Invoker, [{
    ...
    value: function check(event) {
      var key = this.seq[this.seqNumber].key;
      var ctrl = this.seq[this.seqNumber].ctrl || false;

      if (event.key === key && (event.ctrlKey || event.metaKey) === ctrl) {
        return true;
      } else {
        return false;
      }
...
module.exports = __webpack_require__(/*! /home/dotnet/napp/babel-issue2/app.js */"./app.js");
